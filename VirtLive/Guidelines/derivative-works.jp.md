...
- 個人で活動しているか、当団体(*Creators除く)に所属していること
- 二次創作を明示的に拒否していないこと
- ガイドラインを制定していないこと
...
なお、YouTubeショートで切り抜き動画を投稿する場合、元動画のタイトルは画面内に表示し、出来るだけ動画へのリンクを含んだQRコードを画面内に表示する必要があります。
...
当団体公式サイトより二次創作登録制度の申請を行ってください。
本登録では、当事務所以外にISnow Creatorsの包括登録になります。
